    ...
    try:
        await self.repo.client.upsert(
            "live_trader_campaigns",
            {
                ...
                "execution_cost_model": campaign.get("execution_cost_model"),
                "manual_delay_seconds": campaign.get("manual_delay_seconds"),
                "activation_price": campaign.get("activation_price"),
                "gross_realised_r": campaign.get("gross_realised_r"),
                "estimated_cost_r": campaign.get("estimated_cost_r"),
                "net_realised_r": campaign.get("net_realised_r"),
                "execution_costs": campaign.get("execution_costs"),
                "evidence_identity_version": campaign.get("evidence_identity_version"),
                "policy_id": campaign.get("policy_id"),
                "scorer_id": campaign.get("scorer_id"),
                "cohort_id": campaign.get("cohort_id"),
                "evaluation_stage": campaign.get("evaluation_stage"),
                "campaign": campaign,
