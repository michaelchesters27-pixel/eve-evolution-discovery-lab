...
def published_campaign_scorer_definition(settings: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "pending_trigger_rule": "entry threshold observed on a provider+receipt timestamped price event at or after durable publication and manual-delay activation",
        "active_exit_rule": "first sampled live price whose provider and receipt timestamps are at/after activation observed at or beyond published stop or target",
