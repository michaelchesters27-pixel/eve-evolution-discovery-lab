-- Persisted operator truth for EVE Scientist.
-- Railway process counters reset on deploy; the operator dashboard must instead
-- prefer persisted dataset authority, learned memory, and completed science events.
